...
@section('content')
        ...
        <form method="post" action="{{ route('admin.app.setting.store') }}" enctype="multipart/form-data">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input type="text" name="google_site_verification" id="google_site_verification" class="form-control w-100"
    ...
    <div class="modal fade" id="exampleqrcode02" tabindex="-1" aria-labelledby="exampleqrcode02Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
